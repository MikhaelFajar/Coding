            ...
            <div id="templatemo_banner">
                <div class="service_box">
                    <fieldset style="width: 400px; margin:  50px auto;">
                        <legend align="left">
                            <strong><h1>&nbsp&nbsp;LOGIN PANITIA&nbsp&nbsp;</h1></strong>
                        </legend>
                        <form action="LoginServlet" method="post">
                            <table border="0" align="center">
                                <td><strong>NIM</strong></td><td><input type="text" name="nimPanitia" ></input></td>
                                <tr></tr>
                                <td colspan="2"></td>
                                <tr></tr>
                                <td><strong>PASSWORD</strong></td><td><input type="password" name="passPanitia" ></input></td><tr></tr>  
